/* ══════════════════════════════════════════════════════════════════════════
   Mar-A-Lavitch — the starting contents for a browser-hosted install.


   Dates are computed at load time so the app always opens on "today",
...
/* ── What a fresh browser-hosted install starts with ─────────────────────*/
global.STARTER_DATA = function () {
  return JSON.parse(JSON.stringify({
    ...
    chemicals: START_CHEMICALS,
    shifts: START_SHIFTS,
    punches: START_PUNCHES,
    breaks: START_BREAKS,
    ...
    shift_requests: [],
    shift_confirmations: {},
    layouts: [START_LAYOUT],
    menu: START_MENU,
    reservations: START_RESERVATIONS,
    waitlist: START_WAITLIST,
    orders: START_ORDERS,
  }));
};
